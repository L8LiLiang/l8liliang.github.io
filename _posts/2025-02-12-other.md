...
## gcov
```
--param=GCOV_KERNEL_PATH=netqe-bj.usersys.redhat.com/share/code-coverage/rhel9.6/kernel-5.14.0-570.15.1.gcov.el9_6 --param=K_NAME=kernel --param=GCOV_KERNEL_VR=5.14.0-570.15.1.gcov.el9_6 --param=USE_NFS_SERVER=netqe-bj.usersys.redhat.com --param=KG_SHARE_CODECOVERAGE_RAW=/home/kdump/vmcore/liali/gcov --param=TEST_TYPE=lialinet --param=USE_DEBUG_DEVEL=1
...
./gen_gcov_report.sh -t lialinet -s liali kernel-5.14.0-570.15.1.gcov.el9_6.x86_64
