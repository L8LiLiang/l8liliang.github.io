...
## git am
```
from: https://zhuanlan.zhihu.com/p/659151104
from: https://blog.csdn.net/qq_31939617/article/details/129841441

$ git apply --stat 0001-limit-log-function.patch   　　　　  # 查看patch的情况
 
$ git apply --check  0001-limit-log-function.patch   　　　  # 检查patch是否能够打上，如果没有任何输出，则说明无冲突，可以打上，如果出现patch does not apply则表示有冲突，则需要git apply --reject xxx
$ git apply --reject 0001-limit-log-function.patch           # 强制打补丁，如果生成*.rej文件则需要手动打补丁  
